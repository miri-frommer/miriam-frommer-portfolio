...
const translations = {
  ...
  proj5_cat: { de: 'Miscellaneous', en: 'Miscellaneous' },
  proj5_title: { de: 'Dies und Das aus dem Studium', en: 'Bits and Pieces from University' },
  proj5_desc: { de: 'Auch wenn es schon länger als fünf Jahre her ist, möchte ich hier trotzdem Projekte aus meiner Studienzeit zeigen, auf die ich heute noch ein bisschen Stolz bin.', en: 'Even though it’s been more than five years, I still want to show some university projects I’m proud of.' },
